...
<head>
    ...
    <title>Arabian Radio Network</title>
    <!-- Bootstrap Core CSS -->
    <link href="{!! asset('public/assets/admin-pro/assets/plugins/bootstrap/css/bootstrap.min.css') !!}" rel="stylesheet">
    <!-- page css -->
    <link href="{!! asset('public/assets/admin-pro/css/pages/login-register-lock.css') !!}" rel="stylesheet">
...
<body class="card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url({!! asset('public/assets/images/background/login-register.jpg') !!}); background-image: none; background-color: #ccc;">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="{{ route('login.submit') }}" method="POST">
                    	@csrf
                        <h3 class="box-title m-b-20 text-center">
                        	<img src="{!! asset('public/assets/images/arn-logo.png') !!}" width="200">
                        </h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="email" name="email" required="" placeholder="Username" value="{{ old('email') }}"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
