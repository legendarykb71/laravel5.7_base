...
@section('title')
	Dashboard | Arabian Radio Network
@endsection
...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="{!! asset('public/assets/images/icon/income.png') !!}" alt="Income" /></div>
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="{!! asset('public/assets/images/icon/expense.png') !!}" alt="Income" /></div>
                        <div class="align-self-center">
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="{!! asset('public/assets/images/icon/assets.png') !!}" alt="Income" /></div>
                        <div class="align-self-center">
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="{!! asset('public/assets/images/icon/staff.png') !!}" alt="Income" /></div>
                        <div class="align-self-center">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive m-t-20">
                        <table class="table vm no-th-brd no-wrap pro-of-month">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width:50px;"><span class="round"><img src="{!! asset('public/assets/images/users/1.jpg') !!}" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr class="active">
                                    <td><span class="round"><img src="{!! asset('public/assets/images/users/2.jpg') !!}" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-success"><img src="{!! asset('public/assets/images/users/3.jpg') !!}" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-primary"><img src="{!! asset('public/assets/images/users/4.jpg') !!}" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-warning"><img src="{!! asset('public/assets/images/users/5.jpg') !!}" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-danger"><img src="{!! asset('public/assets/images/users/6.jpg') !!}" alt="user" width="50"></span></td>
                                    <td>
                ...
                <div class="activity-box">
                    <div class="card-body">
                        ...
                        <div class="activity-item">
                            <div class="round m-r-20"><img src="{!! asset('public/assets/images/users/2.jpg') !!}" alt="user" width="50" /></div>
                            <div class="m-t-10">
                                ...
                                <table class="table vm b-0 m-b-0">
                                    <tr>
                                        <td class="m-r-10 b-0"><img src="{!! asset('public/assets/images/icon/zip.png') !!}" alt="user" /></td>
                                        <td class="b-0">
                        ...
                        <!-- Activity item-->
                        <div class="activity-item">
                            <div class="round m-r-20"><img src="{!! asset('public/assets/images/users/3.jpg') !!}" alt="user" width="50" /></div>
                            <div class="m-t-10">
                                ...
                                <span class="image-list m-t-20">
                                    <a href="javascript:void(0)"><img src="{!! asset('public/assets/images/users/1.jpg') !!}" class="img-circle" alt="user" width="50"></a>
                                    <a href="javascript:void(0)"><img src="{!! asset('public/assets/images/users/2.jpg') !!}" class="img-circle" alt="user" width="50"></a>
                        ...
                        <!-- Activity item-->
                        <div class="activity-item">
                            <div class="round m-r-20"><img src="{!! asset('public/assets/images/users/4.jpg') !!}" alt="user" width="50" /></div>
                            <div class="m-t-10">
                                <h5 class="m-b-0 font-medium">David R. Jones  <span class="text-muted font-14 m-l-10">| &nbsp; 9:30 PM, July 13th</span></h5>
                                <h6 class="text-muted">uploaded this file </h6>
                                <span>
                                    <a href="javascript:void(0)" class="m-r-10"><img src="{!! asset('public/assets/images/big/img1.jpg') !!}" alt="user" width="60"></a>
                                    <a href="javascript:void(0)" class="m-r-10"><img src="{!! asset('public/assets/images/big/img2.jpg') !!}" alt="user" width="60"></a>
                                </span>
                            </div>
                        </div>
                        <!-- Activity item-->
                        <!-- Activity item-->
                        <div class="activity-item">
                            <div class="round m-r-20"><img src="{!! asset('public/assets/images/users/6.jpg') !!}" alt="user" width="50" /></div>
                            <div class="m-t-10">
    ...
    <div class="row">
        <div class="col-lg-4 col-xlg-3">
            <div class="card">
                <img class="card-img-top img-responsive" src="{!! asset('public/assets/images/big/img1.jpg') !!}" alt="Card image cap">
                <div class="card-body">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    ...
                                    <li><img src="{!! asset('public/assets/images/users/2.jpg') !!}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                    <li><img src="{!! asset('public/assets/images/users/3.jpg') !!}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                    <li><img src="{!! asset('public/assets/images/users/4.jpg') !!}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                </ul>
                            </li>
                            <li class="list-group-item" data-role="task">
        ...
        <div class="col-lg-6 col-xlg-4">
            <div class="card">
                <div class="card-body little-profile text-center">
                    <div class="pro-img m-t-20"><img src="{!! asset('public/assets/images/users/4.jpg') !!}" alt="user"></div>
                ...
                <div class="card-body">
                    ...
                    <div class="message-box contact-box">
                        <div class="message-widget contact-widget">
                            ...
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"> <img src="{!! asset('public/assets/images/users/5.jpg') !!}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                <div class="mail-contnet">
                                    <h5>Andrew</h5> <span class="mail-desc">and@gmail.com</span></div>
                            </a>
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"> <img src="{!! asset('public/assets/images/users/6.jpg') !!}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                <div class="mail-contnet">
            ...
            <div class="card">
                ...
                <div class="comment-widgets">
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="{!! asset('public/assets/images/users/1.jpg') !!}" alt="user" width="50"></span></div>
                    ...
                    <div class="d-flex flex-row comment-row active">
                        <div class="p-2"><span class="round"><img src="{!! asset('public/assets/images/users/2.jpg') !!}" alt="user" width="50"></span></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="{!! asset('public/assets/images/users/3.jpg') !!}" alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                ...
                <div class="card-body">
                    ...
                    <div class="chat-box">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="{!! asset('public/assets/images/users/1.jpg') !!}" alt="user" /></div>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="{!! asset('public/assets/images/users/2.jpg') !!}" alt="user" /></div>
                                <div class="chat-content">
                                    <h5>Bianca Doe</h5>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="{!! asset('public/assets/images/users/3.jpg') !!}" alt="user" /></div>
                                <div class="chat-content">
...
@section('scripts')
    ...
    <script src="{!! asset('public/assets/admin-pro/assets/plugins/chartist-js/dist/chartist.min.js') !!}"></script>
    <script src="{!! asset('public/assets/admin-pro/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js') !!}"></script>
    <!--c3 JavaScript -->
    <script src="{!! asset('public/assets/admin-pro/assets/plugins/d3/d3.min.js') !!}"></script>
    <script src="{!! asset('public/assets/admin-pro/assets/plugins/c3-master/c3.min.js') !!}"></script>
    <!-- Chart JS -->
    <script src="{!! asset('public/assets/admin-pro/js/dashboard2.js') !!}"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="{!! asset('public/assets/admin-pro/assets/plugins/styleswitcher/jQuery.style.switcher.js') !!}"></script>
@endsection